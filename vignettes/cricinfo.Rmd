...
saveRDS(menODI, here::("inst/extdata/menODI.rds"))
saveRDS(Indfielding, here::("inst/extdata/Indfielding.rds"))
saveRDS(MegLanning, here::("inst/extdata/MegLanning.rds"))
```

```{r loaddata, include=FALSE}
wt20 <- readRDS(here::here("inst/extdata/wt20.rds"))
menODI <- readRDS(here::here("inst/extdata/menODI.rds"))
Indfielding <- readRDS(here::here("inst/extdata/Indfielding.rds"))
